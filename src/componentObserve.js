...
function findDOMNode(component) {
    if (Inferno.options.findDOMNodeEnabled) return Inferno.findDOMNode(component)
    return null
}
     ...
     */
        ...
        const initialRender = () => {
            if (!reactiveRender.$nx) {
                signal = this.$observer = observer.observe(() => {
                    ...
                    if (self.__$nxIsUnmounted !== true) {
                        ...
                        try {
                            ...
                            if (hasError) {
                                console.warn(`hasError`, this, signal)
                                if (this.$observer) observer.unobserve(this.$observer)
...
ComponentObserve.propTypes = { children: PropTypes.func.isRequired }
